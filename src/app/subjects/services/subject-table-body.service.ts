...
export class SubjectTableBodyService {
  ...
  public computeAverageMarkByField(field: ICell<string>): number {
    let count: number = 0;
  ...
  public createBodyField(student: Student): TNullable<ICell<string>> {
    return student === null
      ? null
      : {
  ...
  public findBodyFieldByMark(body: Array<ICell<string>>, mark: Mark): TNullable<ICell<string>> {
  ...
  public getStudentByMark(students: Array<Student>, mark: Mark): TNullable<Student> {
